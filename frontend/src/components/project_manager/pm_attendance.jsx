...
const Pm_attandace = () => {
    ...
    const { managerId } = useParams(); // ✅ Corrected from supervisorId to managerId

    // ✅ Fetch assigned sites for the project manager
    useEffect(() => {
        if (managerId) {
            console.log("Fetching assigned sites for Project Manager ID:", managerId);
            axios.get(`http://localhost:5004/api/managers/pmsites/${managerId}`) // ✅ Corrected URL
                .then(res => {
            ...
            <div style={styles.row}>
                <div style={styles.main}>
                    ...
                    <div style={styles.header}>
                        Project Manager Attendance Dashboard
                    </div>
